...
async function setCardsField(cardId){
    await removeAllCardsaImages()
    let computerCardId = await getRandomCardId()
    let duelResults = await checkDuelResults(cardId, computerCardId)
    await showHiddenCardsFieldsImages(true)
    await drawCardsInFiels(cardId, computerCardId)
    await hiddenCardDetaisl()
    await updateScore()
    await drawButton(duelResults)
}

async function drawCardsInFiels(cardId, computerCardId){
...
async function hiddenCardDetaisl(){
...
async function removeAllCardsaImages(){
